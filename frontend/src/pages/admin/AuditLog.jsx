...
const AuditLog = () => {
  ...
  const actionTypes = ['All Actions', 'KYC_APPROVED', 'KYC_REJECTED', 'USER_CREATED', 'BOOKING_CREATED'];
        ...
        <div className="audit-log-container">
          ...
          <div className="audit-search-card">
            <div className="audit-search-wrapper">
              <svg className="audit-search-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="audit-filter-wrapper">
              <svg className="audit-filter-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <tbody>
                {auditEntries.map((entry) => (
                  <tr key={entry.id}>
                    ...
                    <td>
                      <span className={`audit-action-badge action-${entry.action.toLowerCase().replace('_', '-')}`}>
                        {entry.action}
                      </span>
                    </td>
                    <td>
